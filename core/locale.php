...
if ($language_override != '') {
    ...
    if (is_readable(BASE_PATH . $language_override . "_$locale")) {
        include_once($language_override . "_$locale");
    }
    else if (is_readable(BASE_PATH . $language_override . "_$locale.php")) {
        include_once($language_override . "_$locale.php");
    }
    else if (is_readable(BASE_PATH . $language_override)) {
        include_once($language_override);
    }
    else if (is_readable(BASE_PATH . $language_override . ".php")) {
