...
if (is_readable(BASE_PATH . 'config/' . $localsiteconfig))
...
var DO, ST, STO;
    ...
    // "Connection" header is forbidden in modern browsers - browser manages it automatically
    if (HTTPTimer != -1) {
...
var patt = /<form[^>]*id="LoginForm"[\s\S]*?<\/form>/i;
