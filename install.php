...
if ($step === 2) {
    ...
    // Generate localsiteconfig.php
    $escapedPass = addslashes($dbpasswd);
    $escapedUpdatePass = addslashes($update_pass);
    ...
    $configContent = "<?php\n// Generated by phpDVDProfiler installer on " . date('Y-m-d H:i:s') . "\n"
        ...
        . "\$dbname = '$dbname';\n"
        . "\$dbuser = '$dbuser';\n"
        . "\$dbpasswd = '$escapedPass';\n"
        . "\$dbtype = 'mysqli';\n"
        . "\$table_prefix = '$table_prefix';\n"
        . "\n"
        . "\$update_login = '$update_login';\n"
        . "\$update_pass = '$escapedUpdatePass';\n"
        . "\$force_formlogin = 1;\n"
        . "\n"
        . "\$sitetitle = '$escapedTitle';\n"
        . "\$skinfile = 'internal';\n"
        . "\$allowskins = true;\n"
